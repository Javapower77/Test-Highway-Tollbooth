...
{
    [FileLocation("ModsSettings/" + nameof(Test_Highway_Tollbooth))]
    ...
    public partial class ModSettings : ModSetting
    {
        ...
        [SettingsUIKeyboardBinding(BindingKeyboard.M, nameof(ToggleMousePositionPanel))]
        public ProxyBinding ToggleMousePositionPanel { get; set; }
    }
}
